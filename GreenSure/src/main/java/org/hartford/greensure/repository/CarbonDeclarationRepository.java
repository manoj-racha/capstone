...
public interface CarbonDeclarationRepository
        ...
        Page<CarbonDeclaration> findByStatusOrderBySubmittedAtDesc(
                        CarbonDeclaration.DeclarationStatus status, Pageable pageable);

        // Used by ADMIN — return all declarations sorted by submission date descending
        ...
        Page<CarbonDeclaration> findByUserType(
                        @Param("userType") User.UserType userType, Pageable pageable);
        ...
        @Query("SELECT d FROM CarbonDeclaration d " +
                        ...
                        "ORDER BY d.submittedAt DESC")
        Page<CarbonDeclaration> findByStatusAndUserType(
